...
Note: the chosen theme of my course diary might hide the R code by default. If you can't see the code, open the code menu from the top right corner of the diary and click “Show All Code”.
